...
export function LoginIllustration() {
  return (
    <div className="relative h-full bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 p-12 flex flex-col justify-center overflow-hidden">
      ...
      <div className="relative z-10 space-y-8">
        ...
        <div className="flex flex-wrap gap-3">
          <div className="bg-white/20 backdrop-blur-sm border border-white/30 px-4 py-2 rounded-lg flex items-center gap-2">
