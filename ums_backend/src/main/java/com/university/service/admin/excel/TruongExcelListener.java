...
// private final Set<String> maTruongInFile = new HashSet<>(); // Kiểm tra trùng
// trong file
...
// errors.add("Dòng " + rowIndex + ": Mã trường '" + maTruong + "' bị trùng lặp
// trong file Excel");
// return;
// }
...
// errors.add("Dòng " + rowIndex + ": Mã trường '" + maTruong + "' đã tồn tại
// trong cơ sở dữ liệu");
// return;
// }
