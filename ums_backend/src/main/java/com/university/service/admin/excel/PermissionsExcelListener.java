...
// private final Set<String> maPermiissionsInFile = new HashSet<>(); // Kiểm tra
// trùng trong file
...
// public PermissionsExcelListener(PermissionsAdminRepository
// permissionsRepository) {
// this.permissionsRepository = permissionsRepository;
// this.maPermissionsInDb = new
// HashSet<>(permissionsRepository.findAllMaPermissions());
// }
...
// // Làm sạch dữ liệu
// String maPermiissions = data.getMaPermissions().trim().toUpperCase(); // Giả
// sử mã trường viết hoa
...
// errors.add("Dòng " + rowIndex + ": Mã Permissions '" + maPermiissions + "' bị
// trùng lặp trong file Excel");
// return;
// }
...
// errors.add("Dòng " + rowIndex + ": Mã Permissions '" + maPermiissions + "' đã
...
// result.setSuccessCount(toSave.isEmpty() ? (rowIndex - 1 - errors.size()) :
// 0); // Nếu còn dữ liệu chưa lưu, coi
// // như chưa thành công
