...
// private final Set<String> maUsersInFile = new HashSet<>(); // Kiểm tra trùng
// trong file
...
// // Làm sạch dữ liệu
// String maUsers = data.getUserName().trim().toUpperCase(); // Giả sử mã trường
// viết hoa
...
// errors.add("Dòng " + rowIndex + ": Mã Users '" + maUsers + "' bị trùng lặp
// trong file Excel");
// return;
// }
...
// errors.add("Dòng " + rowIndex + ": Mã Users '" + maUsers + "' đã tồn tại
// trong cơ sở dữ liệu");
// return;
// }
