...
// public class UsersAminController {

// private final UsersAdminService usersAdminService;

// @PostMapping
// public ResponseEntity<UsersAdminResponseDTO> create(@Valid @RequestBody
// UsersAdminRequestDTO dto) {
...
// @PutMapping("/{id}")
// public ResponseEntity<UsersAdminResponseDTO> update(@Valid @PathVariable UUID
// id,
